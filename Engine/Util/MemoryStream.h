...
namespace Bat
{
	...
	public:
		...
		static MemoryStream FromFile( FileSystem& filesystem, const std::string& filename );
		static MemoryStream FromFile( FileSystem& filesystem, const std::wstring& filename );
	private:
