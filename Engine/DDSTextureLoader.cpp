...
HRESULT Bat::CreateDDSTextureFromMemory(
...
_Use_decl_annotations_
HRESULT Bat::CreateDDSTextureFromMemoryEx(
	ID3D11Device* d3dDevice,
	const uint8_t* ddsData,
	size_t ddsDataSize,
	size_t maxsize,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HRESULT Bat::CreateDDSTextureFromFile(
	ID3D11Device* d3dDevice,
...
_Use_decl_annotations_
HRESULT Bat::CreateDDSTextureFromFileEx(
	ID3D11Device* d3dDevice,
	const wchar_t* fileName,
	size_t maxsize,
	D3D11_USAGE usage,
