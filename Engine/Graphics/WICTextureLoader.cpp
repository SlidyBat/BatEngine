...
namespace
{
	...
	const WICHasAlpha g_WICHasAlpha[] =
	{
		{ GUID_WICPixelFormatBlackWhite,            false },

		{ GUID_WICPixelFormat1bppIndexed,           true },
		{ GUID_WICPixelFormat2bppIndexed,           true },
		{ GUID_WICPixelFormat4bppIndexed,           true },
		{ GUID_WICPixelFormat8bppIndexed,           true },

		{ GUID_WICPixelFormat2bppGray,              false },
		{ GUID_WICPixelFormat4bppGray,              false },

		{ GUID_WICPixelFormat16bppGrayFixedPoint,   false },
		{ GUID_WICPixelFormat32bppGrayFixedPoint,   false },

		{ GUID_WICPixelFormat16bppBGR555,           true },

		{ GUID_WICPixelFormat32bppBGR101010,        true },

		{ GUID_WICPixelFormat24bppBGR,              false },
		{ GUID_WICPixelFormat24bppRGB,              false },
		{ GUID_WICPixelFormat32bppPBGRA,            true },
		{ GUID_WICPixelFormat32bppPRGBA,            true },

		{ GUID_WICPixelFormat48bppRGB,              false },
		{ GUID_WICPixelFormat48bppBGR,              false },
		{ GUID_WICPixelFormat64bppBGRA,             true },
		{ GUID_WICPixelFormat64bppPRGBA,            true },
		{ GUID_WICPixelFormat64bppPBGRA,            true },

		{ GUID_WICPixelFormat48bppRGBFixedPoint,    false },
		{ GUID_WICPixelFormat48bppBGRFixedPoint,    false },
		{ GUID_WICPixelFormat64bppRGBAFixedPoint,   true },
		{ GUID_WICPixelFormat64bppBGRAFixedPoint,   true },
		{ GUID_WICPixelFormat64bppRGBFixedPoint,    false },
		{ GUID_WICPixelFormat64bppRGBHalf,          false },
		{ GUID_WICPixelFormat48bppRGBHalf,          false },

		{ GUID_WICPixelFormat128bppRGBAFloat,       true },
		{ GUID_WICPixelFormat128bppPRGBAFloat,      true },
		{ GUID_WICPixelFormat128bppRGBFloat,        false },
		{ GUID_WICPixelFormat128bppRGBAFixedPoint,  true },
		{ GUID_WICPixelFormat128bppRGBFixedPoint,   false },
		{ GUID_WICPixelFormat32bppRGBE,             false },

		{ GUID_WICPixelFormat32bppCMYK,             false },
		{ GUID_WICPixelFormat64bppCMYK,             false },
		{ GUID_WICPixelFormat40bppCMYKAlpha,        true },
		{ GUID_WICPixelFormat80bppCMYKAlpha,        true },

		{ GUID_WICPixelFormat64bppRGBAHalf,         true },
		{ GUID_WICPixelFormat64bppRGBA,             true },

		{ GUID_WICPixelFormat32bppRGBA,             true },
		{ GUID_WICPixelFormat32bppBGRA,             true },
		{ GUID_WICPixelFormat32bppBGR,              false },

		{ GUID_WICPixelFormat32bppRGBA1010102XR,    true },
		{ GUID_WICPixelFormat32bppRGBA1010102,      true },

		{ GUID_WICPixelFormat16bppBGRA5551,         true },
		{ GUID_WICPixelFormat16bppBGR565,           false },

		{ GUID_WICPixelFormat32bppGrayFloat,        false },
		{ GUID_WICPixelFormat16bppGrayHalf,         false },
		{ GUID_WICPixelFormat16bppGray,             false },
		{ GUID_WICPixelFormat8bppGray,              false },

		{ GUID_WICPixelFormat8bppAlpha,             true },

	#if (_WIN32_WINNT >= _WIN32_WINNT_WIN8) || defined(_WIN7_PLATFORM_UPDATE)
		{ GUID_WICPixelFormat32bppRGB,              false },
		{ GUID_WICPixelFormat64bppRGB,              false },
		{ GUID_WICPixelFormat64bppPRGBAHalf,        true },
	#endif
	};
	...
	//---------------------------------------------------------------------------------
	size_t _WICHasAlpha( const GUID& guid )
	{
		for( size_t i = 0; i < _countof( g_WICHasAlpha ); ++i )
		{
			if( memcmp( &g_WICHasAlpha[i].format, &guid, sizeof( GUID ) ) == 0 )
				return g_WICHasAlpha[i].has_alpha;
		}
	...
	HRESULT CreateTextureFromWIC( _In_ ID3D11Device* d3dDevice,
		...
		_Outptr_opt_ WIC_TEXTURE_FLAGS* flags = nullptr )
	{
		UINT width, height;
		...
		if( flags )
		{
			int* tex_flags = reinterpret_cast<int*>(flags);
			*tex_flags = 0;

			if( _WICHasAlpha( pixelFormat ) )
			{
				*tex_flags |= WIC_TEXTURE_HAS_ALPHA;
			}
		}
...
HRESULT Bat::CreateWICTextureFromMemory(
...
_Use_decl_annotations_
HRESULT Bat::CreateWICTextureFromMemoryEx(
	ID3D11Device* d3dDevice,
	const uint8_t* wicData,
	size_t wicDataSize,
	size_t maxsize,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HRESULT Bat::CreateWICTextureFromFile(
	ID3D11Device* d3dDevice,
...
_Use_decl_annotations_
HRESULT Bat::CreateWICTextureFromFileEx(
	ID3D11Device* d3dDevice,
	const wchar_t* fileName,
	size_t maxsize,
	D3D11_USAGE usage,
